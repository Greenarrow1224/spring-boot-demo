...
public class WebIATWS extends WebSocketListener {
	...
	private static final String appid = "4654bbbd"; //在控制台-我的应用获取
	private static final String apiSecret = "M2JmNmYyYzExZDFlOWQzMmJhZWJmZTBh"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "43289070bf71b850d91b2ce2de95415c"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String file = "D:\\Downloads\\iat_ws_java_demo\\resource\\iat\\16k_10.pcm"; // 中文
