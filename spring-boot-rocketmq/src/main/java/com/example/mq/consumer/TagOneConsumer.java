 ...
 * @author greenarrow
 * @version 1.0.0
 * @description 按照 tag 过滤消息消费 Tag模式
 * @date 2022-11-01 10:08
 **/
@Slf4j
@Component
...
public class TagOneConsumer implements RocketMQListener<String>, RocketMQPushConsumerLifecycleListener {
    /**
     * 消费者
     * 程序报错则进行重试
     *
