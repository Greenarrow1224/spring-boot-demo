...
@Slf4j
@Component
@RocketMQMessageListener(topic = "test",//主题
        consumerGroup = "test_demo",//消费组  唯一
        /* 下面都有默认值,可选  */
...
public class SimpleConsumer implements RocketMQListener<OrderPaidEvent>, RocketMQPushConsumerLifecycleListener {
    @Override
