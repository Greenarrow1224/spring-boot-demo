 ...
 * @author greenarrow
 * @version 1.0.0
 * @description 集群模式消费，负载均衡模式消费（常用）
 * @date 2022-11-01 9:59
 **/
@Slf4j
@Component
...
public class ClusterConsumer implements RocketMQListener<String>, RocketMQPushConsumerLifecycleListener {
    /**
     * 消费者
     * 程序报错则进行重试
     *
