...
import com.example.mq.dto.BatchMessageEvent;
...
@Slf4j
@Component
@RocketMQMessageListener(topic = "Consumer_Batch",consumerGroup = "Consumer_Batch_group")
public class BatchConsumer implements RocketMQListener<BatchMessageEvent>, RocketMQPushConsumerLifecycleListener {
    @Override
    public void onMessage(BatchMessageEvent message) {
